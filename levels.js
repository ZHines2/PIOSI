...
export const levelSettings = [
  ...
  },
  {
    ...
    enemies: [
      ...
      { name: "New Enemy", symbol: "N", attack: 2, range: 1, hp: 10, agility: 2, x: 4, y: 6 },
      { name: "New Enemy", symbol: "N", attack: 2, range: 1, hp: 10, agility: 2, x: 5, y: 6 },
      { name: "New Enemy", symbol: "N", attack: 2, range: 1, hp: 10, agility: 2, x: 6, y: 6 }
    ]
  },
  {
    level: 99,
